...
import { GenerateImageArgs, SUPPORTED_ASPECT_RATIOS, SUPPORTED_IMAGE_SIZES } from '../types/index.js';
  ...
  inputSchema: {
    ...
    properties: {
      ...
      aspectRatio: {
        ...
        description: 'Output aspect ratio. Valid values: 1:1, 1:4, 1:8, 2:3, 3:2, 3:4, 4:1, 4:3, 4:5, 5:4, 8:1, 9:16, 16:9, 21:9.',
        default: '1:1',
      },
      imageSize: {
        type: 'string',
